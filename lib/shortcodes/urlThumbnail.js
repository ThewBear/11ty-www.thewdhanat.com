...
class ThumbnailGenerator {
  ...
  async capture(src, thumbnailFile) {
    ...
    console.log(1, ((1 - (os.freemem() / os.totalmem())) * 100).toFixed(2))
    ...
    await page.close();
    console.log(2, ((1 - (os.freemem() / os.totalmem())) * 100).toFixed(2))
    await Image(thumbnailFile, this.imageOptions);
    console.log(3, ((1 - (os.freemem() / os.totalmem())) * 100).toFixed(2))
    this.process();
  }
